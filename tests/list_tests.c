...
static void test_list_first(void **state) {
    int *value = malloc(sizeof(int));
    dtal_list_push_left(list, value);
    assert_ptr_equal(value, dtal_list_first(list));
}

static void test_list_last(void **state) {
    int *value = malloc(sizeof(int));
    dtal_list_push(list, value);
    assert_ptr_equal(value, dtal_list_last(list));
}
...
int main() {
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_list_first),
        cmocka_unit_test(test_list_last),
    };
